...
class SocketEngineTest: XCTestCase {
    ...
    override func setUp() {
        ...
        manager = SocketManager(socketURL: URL(string: "http://107.174.238.50:10015/")!)
        socket = manager.defaultSocket
        engine = SocketEngine(client: manager, url: URL(string: "http://107.174.238.50:10015/")!, options: nil)
