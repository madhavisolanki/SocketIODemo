...
class SocketSideEffectTest: XCTestCase {
    ...
    override func setUp() {
        ...
        manager = SocketManager(socketURL: URL(string: "http://107.174.238.50:10015/")!, config: [.log(false)])
        socket = manager.defaultSocket
        socket.setTestable()
    }
}
...
class TestEngine : SocketEngineSpec {
    ...
    private(set) var urlPolling = URL(string: "http://107.174.238.50:10015/")!
    private(set) var urlWebSocket = URL(string: "http://107.174.238.50:10015/")!
