...
class SocketMangerTest : XCTestCase {
    ...
    func testManagerSetsConfigs() {
        ...
        manager = TestManager(socketURL: URL(string: "http://107.174.238.50:10015/")!, config: [
            .handleQueue(queue),
            .forceNew(true),
            .reconnects(false),
            .reconnectWait(5)
    ...
    override func setUp() {
        ...
        manager = TestManager(socketURL: URL(string: "http://107.174.238.50:10015/")!, config: [.log(false)])
        socket = nil
        socket2 = nil
    }
}
